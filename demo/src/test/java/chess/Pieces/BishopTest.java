...
public class BishopTest {
    ...
    board.setPieceAt(new Bishop(Color.BLACK), "A4" );
    board.setPieceAt(new Bishop(Color.WHITE), "B5" );
    ...
    board.setPieceAt(new Bishop(Color.BLACK), "C6" );
    ...
    board.setPieceAt(new Bishop(Color.BLACK), "C4" );
    ...
    board.setPieceAt(new Bishop(Color.BLACK), "A6" );
